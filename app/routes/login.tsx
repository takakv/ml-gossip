  ...
  return (
    <Layout>
      <div className="h-full justify-center items-center flex flex-col gap-y-4">
        <Link to="/register">
          <button className="absolute top-8 right-8 rounded-xl bg-primary text-primary-foreground font-semibold px-3 py-2 transition duration-300 ease-in-out hover:bg-primary/90 hover:-translate-y-1">
            Loo konto
          </button>
        </Link>
        ...
        <p className="font-semibold text-primary-foreground/80">Logi sisse</p>

        <form
          onSubmit={handleSubmit}
          className="rounded-2xl bg-muted mx-4 p-4"
        >
          ...
          <div className="w-full text-center">
            <button
              ...
              className="rounded-xl mt-2 bg-primary text-primary-foreground px-3 py-2 font-semibold transition duration-300 ease-in-out hover:bg-primary/90 hover:-translate-y-1"
            >
              Logi sisse
            </button>
          </div>
